...
def load_mame(path, dataframe=False):
    ...
    if dataframe:
        ...
        x_train = [os.path.join(path+os.sep,INPUT_PATH+os.sep, 'data', img_name) for img_name in x_train_files]
        x_val = [os.path.join(path+os.sep,INPUT_PATH+os.sep, 'data', img_name) for img_name in x_val_files]
        x_test = [os.path.join(path+os.sep,INPUT_PATH+os.sep,'data', img_name) for img_name in x_test_files]
